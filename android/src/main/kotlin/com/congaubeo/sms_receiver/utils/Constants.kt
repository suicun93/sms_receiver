package com.congaubeo.sms_receiver.utils
...
object Constants {
  ...
  // Channels
  const val CHANNEL_SMS = "plugins.congaubeo.com/foreground_sms_channel"
  const val CHANNEL_SMS_BACKGROUND = "plugins.congaubeo.com/background_sms_channel"

  // Intent Actions
  const val ACTION_SMS_SENT = "plugins.congaubeo.intent.ACTION_SMS_SENT"
  const val ACTION_SMS_DELIVERED = "plugins.congaubeo.intent.ACTION_SMS_DELIVERED"
  ...
  // Shared Preferences
  const val SHARED_PREFERENCES_NAME = "com.congaubeo.android_telephony_plugin"
