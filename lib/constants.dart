part of 'sms_receiver.dart';

const _FOREGROUND_CHANNEL = 'plugins.congaubeo.com/foreground_sms_channel';
const _BACKGROUND_CHANNEL = 'plugins.congaubeo.com/background_sms_channel';
